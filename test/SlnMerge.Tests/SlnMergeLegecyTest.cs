...
public class SlnMergeLegacyTest
{
    [Fact]
...
".Trim());
        ...
        var mergedSolutionFile = SlnMergeLegacy.Merge(baseSln, overlaySln, new SlnMergeSettings(), SlnMergeNullLogger.Instance);
...
".Trim());
        ...
        var mergedSolutionFile = SlnMergeLegacy.Merge(
            baseSln,
            overlaySln,
...
".Trim());
        ...
        var mergedSolutionFile = SlnMergeLegacy.Merge(baseSln, overlaySln, new SlnMergeSettings() { ProjectConflictResolution = ProjectConflictResolution.PreserveAll }, SlnMergeNullLogger.Instance);
        var content = mergedSolutionFile.ToFileContent();
        Assert.Equal(@"
Microsoft Visual Studio Solution File, Format Version 12.00
# Visual Studio 16
...
".Trim());
        ...
        var mergedSolutionFile = SlnMergeLegacy.Merge(baseSln, overlaySln, new SlnMergeSettings() { ProjectConflictResolution = ProjectConflictResolution.PreserveUnity }, SlnMergeNullLogger.Instance);
        var content = mergedSolutionFile.ToFileContent();
        Assert.Equal(@"
Microsoft Visual Studio Solution File, Format Version 12.00
# Visual Studio 16
...
".Trim());
        ...
        var mergedSolutionFile = SlnMergeLegacy.Merge(baseSln, overlaySln, new SlnMergeSettings(){ ProjectConflictResolution = ProjectConflictResolution.PreserveOverlay }, SlnMergeNullLogger.Instance);
        var content = mergedSolutionFile.ToFileContent();
        Assert.Equal(@"
Microsoft Visual Studio Solution File, Format Version 12.00
# Visual Studio 16
