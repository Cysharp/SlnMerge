...
{
    public static class SlnMergeLegacy
    {
        ...
        internal /* for test */ static SolutionFile Merge(SolutionFile solutionFile, SolutionFile overlaySolutionFile, SlnMergeSettings settings, ISlnMergeLogger logger)
        {
    ...
    internal class SolutionDocLine
    {
    ...
    internal abstract class SolutionSectionContainer<TSection> : SolutionDocumentNode
    ...
    internal abstract class SolutionSection : SolutionDocumentNode
    {
        protected abstract string Tag { get; }
    ...
    internal class SolutionDocumentTrivialNode : SolutionDocumentNode
    {
    ...
    internal class SolutionProject : SolutionSectionContainer<SolutionProjectSection>
    {
        ...
        public bool IsFolder => string.Compare(TypeGuid, SlnMergeLegacy.GuidProjectTypeFolder, StringComparison.OrdinalIgnoreCase) == 0;
    ...
    internal class SolutionProjectSection : SolutionSection
    {
    ...
    internal class SolutionGlobal : SolutionSectionContainer<SolutionGlobalSection>
    {
    ...
    internal class SolutionGlobalSection : SolutionSection
    {
